...
query_string = 'SELECT Boolean__c, Currency__c, Date__c, Date_Time__c, Id, Index__c, Multi_Pick_List__c, Number__c, Picklist__c FROM ' + TABLE_NAME
...
while iteration < 20:
    ...
    if 'queryMoreResponse' in json_str['soapenv:Envelope']['soapenv:Body'] :
